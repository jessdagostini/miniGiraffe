...
mG_files = ["miniGiraffe2048", "miniGiraffeNC", "perf-utils.so", "time-utils.so", "set-env.sh"]
...
seed_path = os.path.join(pipeline.destination_folder, "dump_proxy_novaseq.bin")
...
cache_size = ["miniGiraffeNC", "miniGiraffe2048"]

scheduler = ['ws', 'omp']

# num_threads = [128, 96, 72, 64, 32, 16, 8, 4, 2, 1]
num_threads = [128, 96, 64, 32]
# num_threads = [1, 2, 4, 8, 16, 32, 64, 72, 96, 128]
