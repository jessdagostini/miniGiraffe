...
# Start pipeline
source_folder = "/home/cc/miniGiraffe"
destination_folder = "/tmp/miniGiraffe"
pipeline = MiniGiraffePipeline(source_folder, destination_folder)

mG_files = ["miniGiraffeNC", "miniGiraffe256", "miniGiraffe2048", "perf-utils.so", "time-utils.so", "set-env.sh"]
...
# Set machine folder with execution pipeline id
model = model + "/6-6"
