...
# Start pipeline
source_folder = "/soe/jessicadagostini/miniGiraffe-amd"
destination_folder = "/lscratch/jessicadagostini/miniGiraffe"
pipeline = MiniGiraffePipeline(source_folder, destination_folder)

mG_files = ["miniGiraffeNC", "miniGiraffe256", "miniGiraffe16384", "perf-utils.so", "time-utils.so", "set-env.sh"]
...
seed_path = os.path.join(pipeline.destination_folder, "dump_proxy_yeast_all_eight.bin")
gbz_path = os.path.join(pipeline.destination_folder, "yeast_all.giraffe.gbz")
# seed_path = os.path.join(grch38_path, "dump_proxy_d1s1l001_ten.bin")
...
# cache_size = ["miniGiraffeNC", "miniGiraffe256", "miniGiraffe16384"]
cache_size = ["miniGiraffeNC","miniGiraffe256", "miniGiraffe16384"]
