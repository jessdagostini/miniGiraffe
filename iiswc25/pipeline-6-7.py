...
mG_files = ["miniGiraffeNC", "miniGiraffe256", "miniGiraffe8192", "perf-utils.so", "time-utils.so", "set-env.sh"]
...
seed_path = os.path.join(pipeline.destination_folder, "dump_proxy_yeast_all_fifth.bin")
